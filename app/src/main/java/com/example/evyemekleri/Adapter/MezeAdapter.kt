...
import com.example.evyemekleri.Model.Meze
import com.example.yemekvetarifleri.Fragment.Detay
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.FirebaseDatabase

class MezeAdapter(val context: Context, val menulerListesi: ArrayList<Meze>) : RecyclerView.Adapter<MezeAdapter.Meze_Holder>()
{
    class Meze_Holder(val binding : RecyclerRowYemeklerBinding) : RecyclerView.ViewHolder(binding.root)
    {
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Meze_Holder
    {
    ...
    override fun onBindViewHolder(holder: Meze_Holder, position: Int)
    {
