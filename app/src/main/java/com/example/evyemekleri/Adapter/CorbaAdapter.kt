...
import com.example.evyemekleri.Model.Corba
import com.example.yemekvetarifleri.Fragment.Detay
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.FirebaseDatabase

class CorbaAdapter(val context: Context, val menulerListesi: ArrayList<Corba>) : RecyclerView.Adapter<CorbaAdapter.Corba_Holder>()
{
    class Corba_Holder(val binding : RecyclerRowYemeklerBinding) : RecyclerView.ViewHolder(binding.root)
    {
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Corba_Holder
    {
    ...
    override fun onBindViewHolder(holder: Corba_Holder, position: Int)
    {
